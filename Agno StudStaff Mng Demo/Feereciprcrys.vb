...
Public Class Feereciprcrys
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agno_StudStaff_Mng_Demo.Feereciprcrys.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFeereciprcrys
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Feereciprcrys = New Feereciprcrys
        rpt.Site = Me.Site
        Return rpt
    End Function
